...
- Menú principal renovado, adaptable a pantalla vertical y horizontal.
- Tarjetas visuales para carpeta, duración de imágenes y collages.
...
- Vídeos: MP4, WebM y otros formatos compatibles mediante Media3/ExoPlayer.
...
- Distribución inteligente según la orientación y relación de aspecto de cada archivo.
...
- `compileSdk`: 36.
- `targetSdk`: 35.
- Utiliza AndroidX Media3/ExoPlayer para la reproducción de vídeo.

## Abrir en Android Studio

1. Abre la carpeta `RandomMediaPlayer_v0.1-source(1)` como proyecto.
...
El proyecto incluye `.github/workflows/build-apk.yml`. Al subirlo a un repositorio de GitHub, el workflow instala Java 17, Android SDK 36 y Gradle 8.13, compila `assembleDebug` y publica `app-debug.apk` dentro del artefacto `RandomMediaPlayer-v0.4-debug`.
